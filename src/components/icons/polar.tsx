...
export function PolarIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            {...props}
        >
            <g clipPath="url(#polar-clip-light)">
                <path
                    fill="#0062FF"
                    fillRule="evenodd"
...
export function PolarDarkIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="300"
            ...
            {...props}
        >
            <g clipPath="url(#polar-clip-dark)">
                <path
                    fill="#fff"
                    fillRule="evenodd"
