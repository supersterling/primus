    ...
    SeatAssign:
      properties:
        ...
        external_member_id:
          ...
          description: >-
            External member ID for the seat assignment. Only supported when
            member_model_enabled is true. Can be used alone (lookup existing
            member) or with email (create/validate member).
        member_id:
          anyOf:
            - type: string
              format: uuid
          ...
          title: Member Id
          description: >-
            Member ID for the seat assignment. Only supported when
