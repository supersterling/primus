...
> **Note:** The `bun` preset is optional, but it configures the build output specifically for Bun's runtime.
...
> **Note:** You do **not** need the custom `start` script when deploying to Vercel.
