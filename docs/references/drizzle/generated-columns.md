...
> **Info:** To use this feature you would need to have `drizzle-orm@0.32.0` or higher and `drizzle-kit@0.23.0` or higher
...
```
> **Warning:** In previous versions, `.generatedAlwaysAs()` also accepted literals as expressions.
> **`string`**
...
```
> **Warning:** In versions before 1.0.0-beta.12, `.generatedAlwaysAs()` also accepted literals as expressions.
> **`string`**
