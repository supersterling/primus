...
> **Error:** This page explains concepts available on drizzle versions `1.0.0-beta.13` and higher.
...
> **Info:** If you don't have a PostgreSQL database yet and want to create one for testing, you can use our guide on how to set up PostgreSQL in Docker.
