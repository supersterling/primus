...
> **Warning:** The types for the `Request` and `Response` objects are in the global scope.
...
> **Warning:** You might see a red underline under the imports if you're using VS Code. The Edge Function will still execute. To get rid of the red underline, you can configure VS Code to use Edge Functions in the next step.
