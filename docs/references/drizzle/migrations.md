...
```
> **Info:** That's a **database first** approach. You have your database schema as a **source of truth** and
...
```
> **Info:** That's a **codebase first** approach. You have your TypeScript Drizzle schema as a **source of truth** and
