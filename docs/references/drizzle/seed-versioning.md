...
```
> **Info:** > This is not an actual API change; it is just an example of how we will proceed with `drizzle-seed` versioning.
...
> **Info:** An older version of the generator could produce intervals like `1 minute 60 seconds` and `2 minutes 0 seconds`, treating them as distinct intervals.
...
> **Info:** Ability to generate a unique string based on the length of the text column (e.g., `varchar(20)`)
