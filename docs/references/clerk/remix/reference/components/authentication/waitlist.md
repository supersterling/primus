...
To learn about how to customize Clerk components, see the [`customization guide`](https://clerk.com/docs/remix/guides/customizing-clerk/appearance-prop/overview.md).
