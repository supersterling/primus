...
If you would like to create a dedicated `/sign-up` page in your Remix application, there are a few requirements you must follow. See the [`dedicated guide`](https://clerk.com/docs/remix/guides/development/custom-sign-up-page.md) for more information.
