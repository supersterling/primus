...
You can also [`add custom actions and links to the <UserButton /> menu`](https://clerk.com/docs/tanstack-react-start/guides/customizing-clerk/adding-items/user-button.md).
