...
If you would like to create a dedicated `/sign-up` page in your TanStack React Start application, there are a few requirements you must follow. See the [`dedicated guide`](https://clerk.com/docs/tanstack-react-start/guides/development/custom-sign-up-page.md) for more information.
