...
| Property                             | Type                                                                                                                                                                                                                                      | Description                                                                                                  |
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| <a id="data"></a> `data`             | <code>undefined | null | <a href="https://clerk.com/docs/tanstack-react-start/reference/hooks/use-organization-creation-defaults.md#organization-creation-defaults-resource">`OrganizationCreationDefaultsResource`</a></code> | The organization creation defaults resource, `undefined` before the first fetch, or `null` if not available. |
