...
The [`useAuth()`](https://clerk.com/docs/tanstack-react-start/reference/hooks/use-auth.md){{ target: '_blank' }} hook provides information about the current auth state, as well as helper methods to manage the current session.
...
The [`useUser()`](https://clerk.com/docs/tanstack-react-start/reference/hooks/use-user.md){{ target: '_blank' }} hook enables you to access the [`User`](https://clerk.com/docs/reference/javascript/user.md) object, which contains the current user's data such as their full name.
