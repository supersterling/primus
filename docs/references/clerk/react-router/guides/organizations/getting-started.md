...
> This guide assumes that you have already set up Clerk in your application. If you haven't, see the [`quickstart guide`](https://clerk.com/docs/react-router/getting-started/quickstart.md).
