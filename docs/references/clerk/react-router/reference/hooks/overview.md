...
- [`useUser()`](https://clerk.com/docs/react-router/reference/hooks/use-user.md)
- [`useClerk()`](https://clerk.com/docs/react-router/reference/hooks/use-clerk.md)
- [`useAuth()`](https://clerk.com/docs/react-router/reference/hooks/use-auth.md)
- [`useSignIn()`](https://clerk.com/docs/react-router/reference/hooks/use-sign-in.md)
- [`useSignUp()`](https://clerk.com/docs/react-router/reference/hooks/use-sign-up.md)
- [`useSession()`](https://clerk.com/docs/react-router/reference/hooks/use-session.md)
- [`useSessionList()`](https://clerk.com/docs/react-router/reference/hooks/use-session-list.md)
- [`useOrganization()`](https://clerk.com/docs/react-router/reference/hooks/use-organization.md)
- [`useOrganizationList()`](https://clerk.com/docs/react-router/reference/hooks/use-organization-list.md)
- [`useOrganizationCreationDefaults()`](https://clerk.com/docs/react-router/reference/hooks/use-organization-creation-defaults.md)
- [`useReverification()`](https://clerk.com/docs/react-router/reference/hooks/use-reverification.md)
