...
In addition, you also can add custom pages and links to the `<OrganizationProfile />` navigation sidenav. For more information, refer to the [`Custom Pages`](https://clerk.com/docs/react-router/guides/customizing-clerk/adding-items/organization-profile.md) documentation.
