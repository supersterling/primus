...
The `useClerk()` composable provides access to the [`Clerk`](https://clerk.com/docs/reference/javascript/clerk.md) object, giving you the ability to build alternatives to any [`Clerk component`](https://clerk.com/docs/nuxt/reference/components/overview.md).
