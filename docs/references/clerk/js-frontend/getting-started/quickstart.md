...
4. ## Initialize Clerk
   ...
   To initialize Clerk, add the following code to your `main.js` file. This code imports your Publishable Key, creates a new [`Clerk`](https://clerk.com/docs/reference/javascript/clerk.md) instance, and calls the [`load()`](https://clerk.com/docs/reference/javascript/clerk.md#load) method to initialize Clerk.
...
2. ## Listen for the `load` event
   ...
   Below the `<script`> tag that initializes the SDK, create another `<script>` tag that listens for the `load` event and call Clerk's [`load()`](https://clerk.com/docs/reference/javascript/clerk.md#load) method to load the SDK, as shown in the following example:
...
- [Create a custom sign-in flow with MFA](https://clerk.com/docs/guides/development/custom-flows/authentication/email-password-mfa.md): Learn how to build a custom sign-in flow with multi-factor authentication.
- [Clerk class reference](https://clerk.com/docs/reference/javascript/clerk.md): Learn more about the&#x20;
- [Clerk JavaScript SDK Reference](https://clerk.com/docs/reference/javascript/overview.md): Learn about the Clerk JavaScript SDK and how to integrate it into your app.
