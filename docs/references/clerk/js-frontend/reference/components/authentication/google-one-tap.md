...
The methods in this section are available on instances of the [`Clerk`](https://clerk.com/docs/reference/javascript/clerk.md) class and are used to render and control the `<GoogleOneTap />` component.
