...
You can customize Clerk components by passing an object of variables to the `variables` property of the [`appearance`](https://clerk.com/docs/expressjs/guides/customizing-clerk/appearance-prop/overview.md) prop.
...
> Please consider this approach with browser compatibility in mind, as it may not work in older browsers. See [`Browser Compatibility Considerations`](https://clerk.com/docs/expressjs/guides/customizing-clerk/appearance-prop/variables.md#browser-compatibility-considerations) for details.
