...
Create an external account with an OAuth provider (e.g., Google, GitHub, see [all providers](https://clerk.com/docs/guides/configure/auth-strategies/social-connections/overview.md#supported-social-providers)):
