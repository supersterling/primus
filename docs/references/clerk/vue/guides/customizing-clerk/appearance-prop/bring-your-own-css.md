...
It's recommended to add this to the [`clerkPlugin()`](https://clerk.com/docs/reference/vue/overview.md) integration so that it's applied to all Clerk components, as shown in the following example. The example names the layer `clerk` but you can name it anything you want.
