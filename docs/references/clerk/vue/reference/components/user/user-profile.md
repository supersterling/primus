...
In addition, you also can add custom pages and links to the `<UserProfile />` navigation sidenav. For more information, refer to the [`Custom Pages documentation`](https://clerk.com/docs/vue/guides/customizing-clerk/adding-items/user-profile.md).
