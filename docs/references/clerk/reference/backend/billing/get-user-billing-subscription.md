...
Retrieves a user's Billing Subscription. Returns a [`CommerceSubscription`](https://clerk.com/docs/reference/backend/types/commerce-subscription.md).
...
This method in the SDK is a wrapper around the BAPI endpoint `GET /users/{user_id}/billing/subscription`. See the [BAPI reference](https://clerk.com/docs/reference/backend-api/tag/billing/get/users/%7Buser_id%7D/billing/subscription.md){{ target: '_blank' }} for more information.
