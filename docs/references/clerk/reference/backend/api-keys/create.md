...
This method in the SDK is a wrapper around the BAPI endpoint `POST/api_keys`. See the [BAPI reference](https://clerk.com/docs/reference/backend-api/tag/api-keys/post/api_keys.md){{ target: '_blank' }} for more information.
