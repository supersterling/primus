...
| <a id="attributemapping"></a> `attributeMapping`     | `AttributeMapping`         | Defines the attribute name mapping between the Identity Provider (IdP) and Clerk's [`User`](https://clerk.com/docs/reference/javascript/user.md) properties. |
