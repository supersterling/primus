...
Updates a [`PhoneNumber`](https://clerk.com/docs/reference/javascript/types/phone-number.md).
...
This method in the SDK is a wrapper around the BAPI endpoint `PATCH/phone_numbers/{phone_number_id}`. See the [BAPI reference](https://clerk.com/docs/reference/backend-api/tag/phone-numbers/patch/phone_numbers/%7Bphone_number_id%7D.md){{ target: '_blank' }} for more information.
