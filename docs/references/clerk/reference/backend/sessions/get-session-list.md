...
This method in the SDK is a wrapper around the BAPI endpoint `GET/sessions`. See the [BAPI reference](https://clerk.com/docs/reference/backend-api/tag/Sessions.md){{ target: '_blank' }} for more information.
