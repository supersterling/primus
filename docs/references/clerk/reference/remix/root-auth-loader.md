...
- [`Without a callback`](https://clerk.com/docs/reference/remix/root-auth-loader.md#without-a-callback), which will just return the auth state
- [`With a callback function`](https://clerk.com/docs/reference/remix/root-auth-loader.md#with-a-callback) to handle custom data loading while having access to auth state

You can also [`pass configuration options`](https://clerk.com/docs/reference/remix/root-auth-loader.md#pass-configuration-options) to `rootAuthLoader()` no matter which method you use.
...
To pass configuration [`options`](https://clerk.com/docs/reference/remix/root-auth-loader.md#root-auth-loader-options) to `rootAuthLoader()`, you can pass an optional argument to the `rootAuthLoader()` function.
...
| publishableKey             | string              | Your Clerk Publishable KeyYour Clerk Publishable Key tells your app what your FAPI URL is, enabling your app to locate and communicate with your dedicated FAPI instance. You can find it on the API keys page in the Clerk Dashboard.. It's recommended to use the environment variable instead.                        |
| secretKey?                 | string              | Your Clerk Secret KeyYour Clerk Secret Key is used to authenticate requests from your backend to Clerk's API. You can find it on the API keys page in the Clerk Dashboard. Do not expose this on the frontend with a public environment variable.. It's recommended to use the environment variable instead.             |
