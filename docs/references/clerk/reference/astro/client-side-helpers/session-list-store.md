...
The `$sessionListStore` store returns an array of [`Session`](https://clerk.com/docs/reference/javascript/session.md){{ target: '_blank' }} objects that have been registered on the client device.
