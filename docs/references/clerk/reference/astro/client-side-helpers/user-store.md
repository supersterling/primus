...
The `$userStore` store provides a convenient way to access current [`User`](https://clerk.com/docs/reference/javascript/user.md){{ target: '_blank' }} data and helper methods for managing the active user.
...
For more information on the `update()` method, see the [`User reference`](https://clerk.com/docs/reference/javascript/user.md#update){{ target: '_blank' }}.
...
For more information on the `reload()` method, see the [`User reference`](https://clerk.com/docs/reference/javascript/user.md#reload){{ target: '_blank' }}.
