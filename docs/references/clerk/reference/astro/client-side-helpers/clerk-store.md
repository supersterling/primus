...
The `$clerkStore` store provides a convenient way to access the [`Clerk`](https://clerk.com/docs/reference/javascript/clerk.md){{ target: '_blank' }} object. This provides access to some methods that are not available in other stores.
