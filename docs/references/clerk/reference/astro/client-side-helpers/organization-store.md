...
The following example demonstrates how to use the `$organizationStore` store to access the [`Organization`](https://clerk.com/docs/reference/javascript/organization.md) object, which allows you to access the current Active Organization.
...
You can implement this pattern to any Clerk function that returns a [`ClerkPaginatedResponse`](https://clerk.com/docs/reference/javascript/types/clerk-paginated-response.md) object.
