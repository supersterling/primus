...
The `$sessionStore` store provides a convenient way to access the current user's [`Session`](https://clerk.com/docs/reference/javascript/session.md){{ target: '_blank' }} object, as well as helpers for setting the active session.
