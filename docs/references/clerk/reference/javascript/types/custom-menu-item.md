...
An interface that provides the ability to add custom menu item to the [`<UserButton />`](https://clerk.com/docs/nextjs/reference/components/user/user-button.md) component.
