...
The following example demonstrates how to revoke an Organization invitation. It first gets the list of Organization invitations using [`getInvitations()`](https://clerk.com/docs/reference/javascript/organization.md#get-invitations) and then revokes the first invitation in the list.
...
- you have [enabled the Organizations feature in the Clerk Dashboard](https://clerk.com/docs/guides/organizations/configure.md#enable-organizations)
