...
> This guide assumes assumes that you have followed the [`Chrome Extension Quickstart`](https://clerk.com/docs/chrome-extension/getting-started/quickstart.md) and then the [Add React Router](https://clerk.com/docs/guides/development/add-react-router.md) guide.

1. ## Add `PLASMO_PUBLIC_CLERK_SYNC_HOST` to your environment variables
   ...
   **Production**
   ...
   ```
2. ## Add `syncHost` prop to your `<ClerkProvider>`
   ...
   ```
3. ### Hide unsupported authentication methods

   When using the Sync Host feature, authentication methods that you want to use in your web app [`may not be fully supported in the Chrome Extension environment`](https://clerk.com/docs/reference/chrome-extension/overview.md#authentication-options). To hide unsupported methods in your Chrome Extension, you can use the [`appearance`](https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/overview.md) prop with your extension's `<SignUp>` and `<SignIn>` components as demonstrated in the following examples.
...
4. ## Configure `host_permissions`
   ...
   ```
5. ## Add the Extension's ID to your web app's `allowed_origins`
   ...
   > If you have not [configured a consistent key](https://clerk.com/docs/guides/development/configure-consistent-crx-id.md), you will have to repeat this step every time your extension's ID changes.
