...
Clerk provides Enterprise Single Sign-On (SSO) through a feature called [**Enterprise Connections**](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/overview.md). You can enable Enterprise Connections for specific Organizations, allowing members to authenticate through their company's identity provider using SAML or OIDC protocols.

When users sign up or sign in using an Organization's Enterprise Connection, Clerk automatically adds them as members of that Organization and assigns them the [default Role](https://clerk.com/docs/guides/organizations/control-access/roles-and-permissions.md#the-default-role-for-members). This process is known as [Just-in-Time (JIT) provisioning](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/jit-provisioning.md).
...
If you need manual control over who joins and their [Roles](https://clerk.com/docs/guides/organizations/control-access/roles-and-permissions.md), use [invitations](https://clerk.com/docs/guides/organizations/add-members/invitations.md). If you want automatic enrollment without IdP requirements, use [Verified Domains](https://clerk.com/docs/guides/organizations/add-members/verified-domains.md).
...
1. [Create an Organization](https://clerk.com/docs/guides/organizations/create-and-manage.md#create-an-organization) for your customer through the Clerk Dashboard.
...
2. After adopting the application, the user [creates an Organization](https://clerk.com/docs/guides/organizations/create-and-manage.md#create-an-organization) for their company.
...
Clerk supports Enterprise SSO via [SAML](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/overview.md#saml) or via the [OpenID Connect (OIDC) protocol](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/overview.md#oidc), either through EASIE or by integrating with any OIDC-compatible provider.

To add an Enterprise SSO Connection for an Organization, go to the [Enterprise Connections](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/overview.md) docs and follow the appropriate guide based on the platform you want to use, such as the [Google SAML guide](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/saml/google.md). When configuring the connection in the Clerk Dashboard, there will be an option to select the **Organization** for which you want to enable this connection. If you don't select an Organization, Clerk will add the connection for your entire application.

> A domain used for Enterprise SSO can't be used as a [Verified Domain](https://clerk.com/docs/guides/organizations/add-members/verified-domains.md) for the same Organization.
...
- [JIT provisioning](https://clerk.com/docs/guides/configure/auth-strategies/enterprise-connections/jit-provisioning.md): Learn more about JIT provisioning to customize how users are automatically added to Organizations.
- [Configure Verified Domains](https://clerk.com/docs/guides/organizations/add-members/verified-domains.md): Learn how to automatically invite users who don't use SSO.
- [Invite specific users](https://clerk.com/docs/guides/organizations/add-members/invitations.md): Learn how to invite specific users to your Organization.
...
- [Configure default Roles](https://clerk.com/docs/guides/organizations/configure.md#default-roles): Learn how to configure default Roles for users joining via SSO.
