...
2. Select the **Username** tab and enable **Sign-up with username** and **Sign-in with username**.
...
3. In the navigation sidenav, select [**SSO connections**](https://dashboard.clerk.com/~/user-authentication/sso-connections).
4. Ensure that _only_ **Google** is enabled.
...
3. In the navigation sidenav, select [**Multi-factor**](https://dashboard.clerk.com/~/user-authentication/multi-factor).
4. Ensure that _only_ **SMS verification code** is enabled.
...
4. In the navigation sidenav, select [**SSO connections**](https://dashboard.clerk.com/~/user-authentication/sso-connections).
5. Ensure that _only_ **Google** is enabled.
6. In the navigation sidenav, select [**Multi-factor**](https://dashboard.clerk.com/~/user-authentication/multi-factor).
7. Ensure that _only_ **SMS verification code** is enabled.
