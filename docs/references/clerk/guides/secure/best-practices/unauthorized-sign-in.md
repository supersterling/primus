...
- [Account Portal](https://clerk.com/docs/guides/account-portal/overview.md) enabled: The user is redirected to the [unauthorized sign-in](https://clerk.com/docs/guides/account-portal/overview.md#unauthorized-sign-in) page, where content can be customized based on the app's theme.
