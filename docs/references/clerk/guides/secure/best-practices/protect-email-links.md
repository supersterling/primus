...
![Error message displayed if email link is opened in a different device or browser if email link same device/browser protection is enabled](https://clerk.com/docs/images/security/email-link_require-same-client.webp)
