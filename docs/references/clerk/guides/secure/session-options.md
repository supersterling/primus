...
- Use the [`<UserButton />`](https://clerk.com/docs/nextjs/reference/components/user/user-button.md) component if you want to use a prebuilt UI.
...
To redirect to a custom route, pass the [`afterMultiSessionSingleSignOutUrl`](https://clerk.com/docs/nextjs/reference/components/clerk-provider.md#properties) property to `<ClerkProvider>`.
