...
> If you find that the use case being described does not fit what you are looking to accomplish with machine authentication, check out the [machine authentication overview](https://clerk.com/docs/guides/development/machine-auth/overview.md) for more information on the different types of machine authentication that Clerk supports and what features are available for each type.
...
If you're using Clerk's [`<UserProfile />`](https://clerk.com/docs/nextjs/reference/components/user/user-profile.md) or [`<OrganizationProfile />`](https://clerk.com/docs/nextjs/reference/components/organization/organization-profile.md) components and have enabled API keys in the Clerk Dashboard, an **API Keys** tab will automatically appear in those profile components. This tab will allow your users to create, view, and revoke API keys, without writing any additional custom code on your end.
...
It's also possible to render the [`<APIKeys />`](https://clerk.com/docs/nextjs/reference/components/api-keys.md) component directly if you want to embed the API key management UI within your own application's interface.
...
On your backend, you can verify the API key using Clerk's SDKs. See the [verifying API keys](https://clerk.com/docs/guides/development/verifying-api-keys.md) guide for framework-specific examples.

## Using API keys via Clerk's SDKs

If you would like to create, list, and revoke API keys programmatically on the server side, you can use Clerk's Backend SDKs. This guide uses the [`JS Backend SDK`](https://clerk.com/docs/js-backend/getting-started/quickstart.md) to demonstrate usage, but **please note that the API keys feature is available in all of Clerk's Backend SDKs**.

### Creating API keys

To create an API key, call the [`create()`](https://clerk.com/docs/reference/backend/api-keys/create.md) method:
...
To list API keys, call the [`list()`](https://clerk.com/docs/reference/backend/api-keys/list.md) method:
...
To verify an API key secret, call the [`verify()`](https://clerk.com/docs/reference/backend/api-keys/verify.md) method:
...
> In most cases, you'll want to verify API keys using framework-specific helpers like `auth()` in Next.js, which handles the verification automatically. See the [verifying API keys guide](https://clerk.com/docs/guides/development/verifying-api-keys.md) for more details.
...
To revoke an API key, call the [`revoke()`](https://clerk.com/docs/reference/backend/api-keys/revoke.md) method:
