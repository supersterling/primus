...
Note that this isn't recommended, and in most cases you should use `auth()` to access auth data at request time instead. For more information, see the guide on [Next.js rendering modes and Clerk](https://clerk.com/docs/guides/development/rendering-modes.md).

## Removed deprecated APIs

The following deprecated APIs have been removed.

- `authMiddleware()` - [Migrate to `clerkMiddleware()`](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/nextjs.md#migrating-to-clerk-middleware)
