...
- 📊 [Telemetry](https://clerk.com/docs/guides/how-clerk-works/security/clerk-telemetry.md) to allow us to better determine feature usage and priority (easy opt-out if you don't like this)
...
If you are [`customizing the component`](https://clerk.com/docs/nextjs/guides/customizing-clerk/adding-items/organization-profile.md) by re-ordering the pages, the label used to target this page must be changed from `settings` to `general` as well.

If you are using the [`appearance prop`](https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/overview.md) to customize the appearance of the `<OrganizationProfile />` component, note that the `cl-profilePage__organizationSettings` key has also been changed to `cl-profilePage__organizationGeneral` to be consistent with the naming change.
...
The default values of some [`appearance variables`](https://clerk.com/docs/nextjs/guides/customizing-clerk/appearance-prop/variables.md) have changed which may impact your UI (if you are not already overriding them).
...
- [Next.js](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/nextjs.md)
- [Remix](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/remix.md)
- [Expo](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/expo.md)
- [Node](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/node.md)
- [Fastify](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/fastify.md)
- [React](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/react.md)
- [Backend](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/backend.md)
- [JS](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/javascript.md)
- [Chrome Extension](https://clerk.com/docs/guides/development/upgrading/upgrade-guides/core-2/chrome-extension.md)
