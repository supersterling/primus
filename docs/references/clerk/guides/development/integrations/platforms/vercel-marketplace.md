...
Refer to the [Configuration documentation](https://clerk.com/docs/guides/configure/auth-strategies/sign-up-sign-in-options.md) for more information on configuring your application.

## Pricing

The pricing for plans and add-ons purchased through the Vercel Marketplace is the same as the pricing when purchased directly through Clerk. For more information on Clerk's pricing and available plans, see the [Pricing page](https://clerk.com/pricing).
