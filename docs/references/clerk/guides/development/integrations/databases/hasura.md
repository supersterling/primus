...
![The JWT templates page in the Clerk Dashboard. The 'New template' button was clicked, and a pop up titled 'New JWT template' is shown. The 'Hasura' template is hovered over](https://clerk.com/docs/images/integrations/hasura/jwt-template.webp)
...
![The 'Create new template' page of the JWT templates page in the Clerk Dashboard](https://clerk.com/docs/images/integrations/hasura/create-template.webp)

The Hasura template will pre-populate the default claims required by Hasura. You can include additional claims as necessary. [Shortcodes](https://clerk.com/docs/guides/sessions/jwt-templates.md#shortcodes) are available to make adding dynamic user values easy.

![The 'Create new template' page of the JWT templates page in the Clerk Dashboard. The page is scrolled down to the 'Claims' section](https://clerk.com/docs/images/integrations/hasura/template-shortcodes.webp)
