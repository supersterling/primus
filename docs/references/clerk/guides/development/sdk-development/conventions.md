...
Any environment variable used in the context of Clerk should be prefixed with `CLERK_`. [Learn more about Clerk environment variables](https://clerk.com/docs/guides/development/clerk-environment-variables.md).
...
Additionally, you need to make the environment variables for [API and SDK configuration](https://clerk.com/docs/guides/development/clerk-environment-variables.md#api-and-sdk-configuration) available to your users.

> The `CLERK_SECRET_KEY` should never be exposed on the client-side (frontend). Always use a server-side environment variable.

### Optional

Clerk recommends implementing the [sign-in and sign-up redirect](https://clerk.com/docs/guides/development/clerk-environment-variables.md#sign-in-and-sign-up-redirects) environment variables.
...
Here's how the [`@clerk/astro`](https://clerk.com/docs/reference/astro/overview.md) package is using subpath exports:
