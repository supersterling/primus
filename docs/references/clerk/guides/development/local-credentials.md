...
This guide demonstrates how to use the [`useLocalCredentials()`](https://clerk.com/docs/reference/expo/use-local-credentials.md) hook in your Expo app to securely store a user's password credentials on their device, enabling biometric sign-in for returning users.
...
3. ## Securely store/access the user's credentials during sign in
   ...
   ```
4. ## Delete credentials while user is signed in
   ...
   ```
5. ## Update credentials while user is signed in
