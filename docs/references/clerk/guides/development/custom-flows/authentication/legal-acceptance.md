...
The following example adds the legal acceptance logic to the [Email and password custom flow](https://clerk.com/docs/guides/development/custom-flows/authentication/email-password.md), but you can apply the same logic to any custom flow.
...
To support legal acceptance, you need to add a checkbox to your sign-up form, capture the checkbox value, and pass it to the [`SignUp.create()`](https://clerk.com/docs/reference/javascript/sign-up.md#create) method.
