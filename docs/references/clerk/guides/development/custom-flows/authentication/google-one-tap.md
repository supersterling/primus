...
1. ## Enable Google as a social connection
   ...
   To use Google One Tap with Clerk, follow the steps in the [dedicated guide](https://clerk.com/docs/guides/configure/auth-strategies/social-connections/google.md#configure-for-your-production-instance) to configure Google as a social connection in the Clerk Dashboard using custom credentials.
2. ## Create the Google One Tap authentication flow
