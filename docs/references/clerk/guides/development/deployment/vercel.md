...
> This guide assumes that you have already installed Clerk in your application locally and are ready to deploy. If you haven't installed Clerk yet, see the [setup guide](https://clerk.com/docs/getting-started/quickstart/setup-clerk.md).
...
> If you would like to deploy to production, you will need to add your **production** API keys to your Vercel project. Refer to the [Deploy to production](https://clerk.com/docs/guides/development/deployment/production.md) guide for more information.
...
To configure Clerk within your Vercel preview environment, see the [guide for configuring a preview environment](https://clerk.com/docs/guides/development/managing-environments.md).

## Deploy to production

If you would like to deploy your Vercel project to production, you will need to add your **production** API keys to your Vercel project. You will also need a domain that you own, as you cannot use a `*.vercel.app` domain for production. Refer to the [Deploy to production](https://clerk.com/docs/guides/development/deployment/production.md) guide for more information.
