...
> This is not recommended. Instead, you should either [set up a staging environment with a subdomain and separate Clerk app](https://clerk.com/docs/guides/development/managing-environments.md) or [use a preview deployment](https://clerk.com/docs/guides/development/managing-environments.md).
