...
the [Backend API](https://clerk.com/docs/reference/backend-api/tag/users/post/users.md){{ target: '_blank' }}.
...
> [Rate limits](https://clerk.com/docs/guides/how-clerk-works/system-limits.md) apply to the [`CreateUser`](https://clerk.com/docs/reference/backend-api/tag/users/post/users.md){{ target: '_blank' }} endpoint. For development instances, a rate limit rule of **100 requests per 10 seconds** is applied. For production instances, that limit goes up to **1000 requests per 10 seconds**.
...
2. ### Rollout changes
   ...
   update your application to use Clerk’s managed [Account Portal](https://clerk.com/docs/guides/account-portal/overview.md) or the [`<SignIn />`](https://clerk.com/docs/nextjs/reference/components/authentication/sign-in.md) component.
