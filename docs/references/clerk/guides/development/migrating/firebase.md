...
3. ### Log in to Firebase
   ...
   firebase login
   ```
4. ### Find your Firebase project ID
   ...
   ```
5. ### Export your Firebase users using the CLI
...
6. ## Retrieve your password hash parameters
...
11. ## Run the script
    ...
    > This implementation does not take rate limiting into account. If you have a large user base, you may want to implement a retry mechanism. Clerk will return a `429` status code if you exceed the rate limit. You can find more information about Clerk's rate limits [here](https://clerk.com/docs/guides/how-clerk-works/system-limits.md). Keep [Firebase's rate limits](https://firebase.google.com/docs/functions/quotas) in mind as well when exporting your users.
