...
You will want to create a long-lived [JWT Template](https://clerk.com/docs/guides/sessions/jwt-templates.md) to be used in Postman or Insomnia. To do so, navigate to the [**JWT templates**](https://dashboard.clerk.com/~/jwt-templates) page in the Clerk Dashboard. Select **New template** then choose the **Blank** template.

![The JWT templates page in the Clerk Dashboard. The 'New template' button was clicked, in the modal that opened, the 'Blank' template is hovered over](https://clerk.com/docs/images/testing/blank-jwt-template.webp)
...
![Creating a JWT template in the Clerk Dashboard](https://clerk.com/docs/images/testing/testing-template.webp)
...
![The Dev Tools Console with the command 'await window.Clerk.session.getToken()' entered. The token is logged to the console](https://clerk.com/docs/images/testing/get-token-from-console.webp)
...
![The Postman app with a red arrow pointing at the plus icon in the top-left corner](https://clerk.com/docs/images/testing/postman-new-request.webp)
...
![The Postman app with a red box around the method and URL field](https://clerk.com/docs/images/testing/postman-configure-request.webp)
...
![The Postman app with the first red arrow pointing at the Authorization tab, the second red arrow pointing at the token type with 'Bearer token' chosen, and a third red arrow pointing at the token field with the token pasted in](https://clerk.com/docs/images/testing/postman-bearer-token.webp)

**Insomnia**

Open Insomnia and create a new request.

![The Insomnia app with a red arrow pointing at the 'New HTTP Request' button](https://clerk.com/docs/images/testing/insomnia-new-request.webp)
...
![The Insomnia app with a red box around the method and URL field](https://clerk.com/docs/images/testing/insomnia-configure-request.webp)
...
![The Insomnia app with the first red arrow pointing at the Auth tab which has been switched to the 'Bearer token' option. The second red arrow points at the token field with the token pasted in](https://clerk.com/docs/images/testing/insomnia-bearer-token.webp)
