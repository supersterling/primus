...
1. ### Clone a template
   ...
   ![The 'clerk-nextjs-app-quickstart' repository page with the 'Code' button clicked on and its drop down menu is opened. There is a red arrow pointing to the 'Code' button](https://clerk.com/docs/images/troubleshooting/how-to-clone.webp)
2. ### Create a Clerk application

   Create a new Clerk application through the Clerk Dashboard. You can follow the [setup guide](https://clerk.com/docs/getting-started/quickstart/setup-clerk.md) to help you get started.
3. ### Set the environment variables

   Set the environment variables in your Clerk application. You can find instructions on how to do so in the appropriate [quickstart guide](https://clerk.com/docs/getting-started/quickstart/overview.md).
4. ### Run the app
...
5. ### Add code to reproduce the issue
