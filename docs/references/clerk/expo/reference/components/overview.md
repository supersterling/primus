...
- [`<Protect />`](https://clerk.com/docs/expo/reference/components/control/protect.md)
...
- [`<SignedIn />`](https://clerk.com/docs/expo/reference/components/control/signed-in.md)
- [`<SignedOut />`](https://clerk.com/docs/expo/reference/components/control/signed-out.md)
