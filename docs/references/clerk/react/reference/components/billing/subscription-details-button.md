...
`<SubscriptionDetailsButton />` must be wrapped inside a [`<SignedIn />`](https://clerk.com/docs/react/reference/components/control/signed-in.md) component to ensure the user is authenticated.
