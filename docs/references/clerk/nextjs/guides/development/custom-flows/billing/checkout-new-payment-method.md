...
- [`Checkout with an existing payment method`](https://clerk.com/docs/nextjs/guides/development/custom-flows/billing/checkout-existing-payment-method.md)
- [`Add a new payment method outside of a checkout flow`](https://clerk.com/docs/nextjs/guides/development/custom-flows/billing/add-new-payment-method.md)
...
2. ## Checkout flow
   ...
   1. Uses the [`useCheckout()`](https://clerk.com/docs/nextjs/reference/hooks/use-checkout.md) hook to get to initiate and manage the checkout session.
