...
| <a id="data"></a> `data`                       | <code><a href="https://clerk.com/docs/reference/javascript/types/billing-payment-method-resource.md">`BillingPaymentMethodResource`</a>[]</code>                                                                                                                                                            | An array that contains the fetched data. For example, for the `memberships` attribute, data will be an array of [`OrganizationMembership`](https://clerk.com/docs/reference/javascript/types/organization-membership.md) objects. |
