...
> **Callout:** ⚠️ slugify() should only be applied to function IDs, not application IDs. Changing the application ID will result new app, archiving the existing one.
